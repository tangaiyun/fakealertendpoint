...
@XmlRootElement(name = "ExternalEvent", namespace = "http://notification.event.successfactors.com")
...
public class EENAlertRequest<S, T extends EENAlertRequestBeanData> implements IPayload{
  ...
  @XmlElement(name = "externalEventMeta", namespace = "http://notification.event.successfactors.com")
   ...
   */
  @XmlElementWrapper(name = "events", namespace = "http://notification.event.successfactors.com")
  ...
  public String toString() {
    if (eenAlertRequestMeta!= null && eenAlertRequestMeta instanceof EENAlertRequestMeta) {
      ...
      return meta.getType() + "(" + meta.getExternalEventId() + ")";
    }
